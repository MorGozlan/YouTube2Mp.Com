...
<head>
  ...
  <meta name="description" content="Convert and download youtube videos to mp3 (audio) or mp4 (video) files for free. MP3 CONVERTER, CONVERTER CONVERT, MP3 AUDIO,MP3 AUDIO, MP4 VIDEO,YOUTUBE TO MP3,AUDIO OR MP4">
...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-4 sidenav">
      ...
      <div class="well">
        <p>Convert and download youtube videos to mp3 (audio) or mp4 (video) files for free. There is no registration or software needed.</p>
      </div>
    </div>
    ...
    <br>
      ...
      <p>  
      <iframe style="border: none;" src="https://www.youtube2mp3.cc/api/" width="100%" height="160" scrolling="no"></iframe>
      </p>
</div>
      <br/>
	 ...
	 <form action="" method="GET" onsubmit="return validatebeforesubmit(this)">
	  <div class="form-group">
	    <label for="url">YouTube Video Link #2</label>
...
echo '<br /><div class="row" style="background:#fff">
	  <div class="col-sm-4">Put link from youtube.</div>
      </div>';
...
<!--      <div>
    ...
    <div class="col-sm-4 sidenav">
      ...
      <div class="well">
        <p>Convert and download youtube videos to mp3 (audio) or mp4 (video) files for free. There is no registration or software needed.<br/>
	</p>
      </div>
    </div>
  </div>
